  ...
  return (
    <div className="backdrop-blur-xl bg-white/30 dark:bg-black/30 border border-white/20 shadow-2xl rounded-2xl p-6 md:p-8 flex items-center justify-between gap-4 w-full max-w-sm mx-auto transition-transform hover:scale-105 duration-300">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-sm font-bold uppercase tracking-wider text-slate-800 dark:text-slate-100">Oferta expira en</h3>
          <p className="text-xs text-slate-600 dark:text-slate-300">Asegura tu descuento</p>
        </div>
      </div>
      <div className="flex gap-2 text-center">
        <div className="bg-white/50 dark:bg-black/40 rounded-lg px-2 py-1 w-12 border border-white/30 shadow-sm">
          ...
          <span className="text-[10px] uppercase font-semibold text-slate-500">Hr</span>
        </div>
        ...
        <div className="bg-white/50 dark:bg-black/40 rounded-lg px-2 py-1 w-12 border border-white/30 shadow-sm">
          ...
          <span className="text-[10px] uppercase font-semibold text-slate-500">Seg</span>
        </div>
      </div>
    </div>
  );
